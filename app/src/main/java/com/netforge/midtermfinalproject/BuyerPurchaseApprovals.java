...
public class BuyerPurchaseApprovals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyer_purchase_approvals);
        ...
        // Initialize Views
        buyerRequestsRecyclerView = findViewById(R.id.approvalsRecyclerView);
